        ...
        >
          <SwiperSlide>
            <div className="grid lg:grid-cols-3 grid-cols-1 gap-10 lg:gap-20">
              <div>
                <img src={photo1} className="mx-auto lg:w-[500px] lg:h-96 " alt="" />
              </div>
              <div className="col-span-2">
                ...
                <p className="mt-5 lg:px-0 px-12">
                  ...
                  technologies and innovative engineering solutions. Faculty and
                  students collaborate on projects ranging from advanced
